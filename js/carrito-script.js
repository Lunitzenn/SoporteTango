// Configuración
const API_URL = 'https://github.com/Lunitzenn/SoporteTango/api';
...
async function cargarProductos() {
    try {
        ...
        productosContainer.innerHTML = '<p style="color: red;">Error al cargar los productos</p>';
    }
}
...
async function cargarCarrito() {
    try {
        ...
        console.error('Error:', error);
        carritoContainer.innerHTML = '<p style="color: red;">Error al cargar el carrito</p>';
    }
}
